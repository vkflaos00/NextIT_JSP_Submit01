...
<script>
	$(function() {
		...
		$('#id_btn_reset').click(
				function() {
					sf.find("select[name='searchType'] option:eq(0)").attr(
							"selected", "selected");
					sf.find("select[name='searchCategory'] option:eq(0)").prop(
							"selected", "selected");
	...
	function fn_boardViewBoNo(boNo) {
		...
		location.href = "${pageContext.request.contextPath}/free/freeView?boNo="
				+ boNo
				+ "&searchType="
				+ st
				+ "&searchWord="
